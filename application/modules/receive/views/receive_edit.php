                                                                                ...
                                                                                <div class="col-md-12 col-sm-6 col-xs-12">
                                                                                        ...
                                                                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div >
                                                                                                    <input type="text" name="annual[0][]" value="<?php echo @$notice->annual; ?>"  id="annual" placeholder="0.00" readonly class="numeric form-control col-md-7 col-xs-12" >
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div >
                                                                                                    <input type="text" name="tax_interest[0][]" value="<?php echo @$notice->tax_interest; ?>" id="interest" placeholder="0.00" class="numeric form-control col-md-7 col-xs-12" >
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div >
                                                                                                    <input type="text" name="sum_amount_tax[0][]" value="<?php echo @$notice->sum_amount_tax; ?>" id="sum_amount_house" readonly class="numeric form-control col-md-7 col-xs-12" >
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <div class="col-md-12 col-sm-6 col-xs-12">
                                                                                    ...
                                                                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div >
                                                                                                <input type="text" name="tax_interest[1][]" value="<?php echo @$notice->tax_interest; ?>" id="interest" placeholder="0.00" class="numeric form-control col-md-7 col-xs-12" >
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div >
                                                                                                <input type="text" name="sum_amount_tax[1][]" value="<?php echo @$notice->sum_amount_tax; ?>" id="sum_amount_local" readonly class="numeric form-control col-md-7 col-xs-12" >
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-md-12 col-sm-6 col-xs-12">
                                                                                        ...
                                                                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div >
                                                                                                    <input type="text" name="tax_interest[2][]" value="<?php echo @$notice->tax_interest; ?>"id="interest" placeholder="0.00" class="numeric form-control col-md-7 col-xs-12" >
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div >
                                                                                                    <input type="text" name="sum_amount_tax[2][]" value="<?php echo @$notice->sum_amount_tax; ?>" id="sum_amount_label" readonly class="numeric form-control col-md-7 col-xs-12" >
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
