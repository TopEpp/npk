...
<table class="table table-bordered jambo_table">
	...
	<?php foreach ($receive as $key => $value) { ?>
		<tr>
			...
			<td style="text-align: center;"><button class="btn btn-success btn-sm" type="button" onclick="window.location.href='<?php echo base_url('receive/receive_tax_pay_add_house/' . $value['notice_id']) ?>'">ชำระภาษี</i></button></td>
		</tr>
	<?php 
} ?>
	</tbody>
