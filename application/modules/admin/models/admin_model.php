...
class admin_model extends CI_Model
{
	...
	function importDataToTemp($tax_id,$data){
		$count_row = 0;
		foreach ($data as $key => $value) {
			$count_row ++;
			if($tax_id==8){
				if($count_row<2) continue;
	...
	function checkIndividual($individual_number){
