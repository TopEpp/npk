        ...
        'columns': [{
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    var btn =
                        '<div class="btn-group ">' +
                        '<button type="button" onclick="window.location.href=\'' + domain + 'receive/other_tax_edit/' + '' + data + '\'" id="edit-receive" class="btn btn-success btn-sm" title="แก้ไข" style="width: 47px;">แก้ไข</button>' +
